...
<TokenTable>
  ...
  <TokenRow token="--fs-cart-item-title-color" value="inherit" />
  <TokenRow token="--fs-cart-item-title-text-decoration" value="none" />
  <TokenRow token="--fs-cart-item-title-outline" value="none" />
</TokenTable>
