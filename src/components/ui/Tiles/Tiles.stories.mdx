...
According to the quantity of items to be displayed, tiles will be arranged differently.

For now, the minimum items is 2 and the maximum is 4, but this component will be improved to accept different possibilities, for example the use of only one tile occupying the entire space of the section.
