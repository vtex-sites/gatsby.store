...
FastStore Gatsby Starter's components library is an ecommerce-focused library **created by VTEX** that provides best-of-breed components, blazing-fast performance, and a frictionless development experience to create storefronts using FastStore UI library as base.

<ButtonLink
  variant="tertiary"
  href="https://gatsby.vtex.app/"
  data-fs-button-size="small"
>
  Gatsby Store Starter
