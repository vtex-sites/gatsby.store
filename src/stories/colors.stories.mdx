  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-main-4)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-main-3)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-main-2)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-main-0)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-main-1)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-link)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-neutral-0)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
    ...
    <tr>
      ...
      <td>
        <div
          style={{
            backgroundColor: 'var(--fs-color-tertiary-bkg-light)',
            width: '1.5rem',
            height: '1.5rem',
            borderRadius: '100%',
            border: '1px solid gray',
