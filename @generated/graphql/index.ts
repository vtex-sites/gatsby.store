...
export type SearchSuggestionsQueryQuery = { search: { suggestions: { terms: Array<string> | null, products: Array<{ slug: string, sku: string, name: string, gtin: string, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, offers: Array<{ availability: string, price: number, listPrice: number, quantity: number, seller: { identifier: string } }> } }> | null } } };
...
export type HomePageQueryQuery = { site: { siteMetadata: { title: string | null, description: string | null, titleTemplate: string | null } | null } | null };
